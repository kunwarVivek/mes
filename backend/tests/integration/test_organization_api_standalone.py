"""
Integration tests for Organization API endpoints (standalone version).
...
organizations_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(organizations_module)
org_router = organizations_module.router


# Test database setup
SQLALCHEMY_DATABASE_URL = "sqlite:///./test_organizations_standalone.db"
