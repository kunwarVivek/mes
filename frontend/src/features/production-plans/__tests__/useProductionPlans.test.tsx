...
describe('useProductionPlans', () => {
  ...
  it('should fetch production plans successfully', async () => {
    ...
    vi.mocked(productionPlanService.getAll).mockResolvedValue(mockData)
    ...
    expect(productionPlanService.getAll).toHaveBeenCalledWith(undefined)
  })
  ...
  it('should fetch production plans with filters', async () => {
    ...
    expect(result.current.data).toEqual(mockData)
    expect(productionPlanService.getAll).toHaveBeenCalledWith(filters)
  })

  it('should handle errors', async () => {
    const error = new Error('Failed to fetch production plans')
    vi.mocked(productionPlanService.getAll).mockRejectedValue(error)
  ...
  it('should show loading state', () => {
    vi.mocked(productionPlanService.getAll).mockImplementation(
