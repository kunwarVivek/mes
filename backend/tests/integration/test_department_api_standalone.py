"""
Integration tests for Department API endpoints (standalone version).
...
# Import router directly without going through __init__.py to avoid circular imports
import sys
import importlib.util
spec = importlib.util.spec_from_file_location(
    "departments",
    "/Users/vivek/jet/unison/backend/app/presentation/api/v1/departments.py"
)
departments_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(departments_module)
dept_router = departments_module.router


# Test database setup
SQLALCHEMY_DATABASE_URL = "sqlite:///./test_departments_standalone.db"
...
app = FastAPI()
app.include_router(dept_router, prefix="/api/v1/departments")
